...
| `RtgGraphDataObjectWrite` | `attribute` | `ref: RtgChangeReference`, `type: String`, `properties: JsonObject`, `system: JsonObject`, `anchorRefs[1..*]: RtgChangeReference`, `identityOverride[0..1]: RtgIdentityOverride` | Defined by its typed fields and action requirements. |
