...
under `docs/reference/` explain that model for humans; they are projections, not a second
contract source.
...
gates in `model/migration/cutover-status.json`. The former Markdown component specifications are frozen as a
